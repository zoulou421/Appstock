 ...
 */
final class Version20220318163644 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD job VARCHAR(50) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP profile_id, DROP job_id, CHANGE firstname firstname VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE name name VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
